...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    address: "smtp.gmail.com", # Gmail's SMTP address
    port: 587,                 # TLS port for Gmail
    domain: "gmail.com",  # You can leave this or change it to your domain
    authentication: "plain",
    user_name: "subhankhalidofficial@gmail.com",  # Your email address
    password: "lndd pbvr dodq cecv",  # Your App Password
    enable_starttls_auto: true  # To enable secure connection
  }
